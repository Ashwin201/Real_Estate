  ...
  return (
    <div>
      ...
      <div className="header">
        <nav className="navbar  navbar-expand-lg sticky-top py-md-3 ">
          <div className="container">
            ...
            <OutsideClickHandler onOutsideClick={()=>{setMenuOpend(true)}}>
              <ul
              ...
              <li className="nav-item">
                ...
                <li className="nav-item">
                  <a className="nav-link active" aria-current="page" href="#residency">
                    Residencies
                  </a>
                </li>
                ...
                <li className="nav-item">
                  <a className="nav-link  mb-3 mb-lg-0" href="#start">Get Started</a>
                </li>
